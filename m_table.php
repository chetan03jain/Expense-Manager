...
if (isset($_POST["submit"]))
 ...
 if($date!=null&&$category==null)
 {
     $query = "SELECT * FROM expense WHERE MONTH(Date) = '". mysqli_real_escape_string($link,$date)."'" ;
...
echo "</table>";
 ...
 if($date!=null&&$category!=null)
 {
	  $query = "SELECT * FROM expense WHERE MONTH(Date) = '". mysqli_real_escape_string($link,$date)."'AND Type= '".mysqli_real_escape_string($link,$category)."'" ;
     $result = mysqli_query($link,$query);
